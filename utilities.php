...
function print_listing_li($productId, $title, $desc, $price, $num_bids, $end_date_str)
{
  ...
  echo ('
    ...
    <div class="p-2 mr-5"><h5><a href="listing.php?productId=' . $productId . '">' . $title . '</a></h5>' . $desc_shortened . '</div>
...
function return_active_if_current_nav($page)
{
  global $currentPage;
