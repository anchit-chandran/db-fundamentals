...
$userDetails = runQuery("SELECT * FROM User WHERE userId = {$_SESSION['userId']}")->fetch_assoc();
?>
...
<div class="row">
    ...
    <div class="col-md-5 border-right">
        <div class="p-3 py-5">
            ...
            <div class="row mt-2">
                <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="first name" value=<?php echo $userDetails['firstName'] ?>></div>
